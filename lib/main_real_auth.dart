...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(isDesktop ? 'Real OAuth Authentication' : 'Firebase Authentication'),
        centerTitle: true,
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                isDesktop ? 'Desktop OAuth Edition' : 'Mobile Edition',
              ...
              if (_isLoading)
                ...
                // Microsoft Sign In Button - only for desktop
                if (isDesktop) ...[
                  SizedBox(
                    width: double.infinity,
                    height: 55,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text(
                      isDesktop ? '💻 Real Desktop OAuth' : '📱 Firebase Authentication',
                      style: TextStyle(
                        fontSize: 14,
                    ...
                    Text(
                      isDesktop 
                        ? '• Real Google & Microsoft OAuth flows\n'
              ...
              PopupMenuItem<String>(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Real ${widget.user.provider.toUpperCase()} Account',

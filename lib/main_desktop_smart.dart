...
void main() async {
  ...
  // Initialize desktop auth service
  await DesktopAuthService().initialize();
...
class _SmartAuthWrapperState extends State<SmartAuthWrapper> {
  final DesktopAuthService _authService = DesktopAuthService();
            ...
            children: [
                  ...
                  children: [
                    ...
                    Text(
                      isOnline 
                        ...
                        : 'No Internet - Offline mode with local storage only',
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    isOnline ? 'Sign in with Google' : 'Google (Simulated)', 
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    isOnline ? 'Sign in with Microsoft' : 'Microsoft (Simulated)', 
                    style: const TextStyle(fontSize: 16)
                  ),
                  style: ElevatedButton.styleFrom(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      ...
                      '• All authentication methods work in both modes',
